...
public class CalculadoraDeSalario {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Regra de calculo para Dev: " + CargoEnum.DESENVOLVEDOR.getRegraDeCalculo().getClass().getSimpleName());
        ...
        System.out.println("Regra de calculo para DBA: " + CargoEnum.DBA.getRegraDeCalculo().getClass().getSimpleName());
    }
}
